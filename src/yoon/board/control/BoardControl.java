...
public class BoardControl extends HttpServlet{
	...
	private void list(HttpServletRequest req, HttpServletResponse res) 
		...
		if(strPg != null) strPg = strPg.trim();
	...
	private void update(HttpServletRequest req, HttpServletResponse res)
		...
		if(rt_mobile != null){
			rt_mobile = rt_mobile.trim();
			if(rt_mobile.equals("mobile")){
				view = "board.do?rt=mobile&method=content&num=" + num;
			}
		}
	...
	private void insert(HttpServletRequest req, HttpServletResponse res)
		...
		if(rt_mobile != null){
			rt_mobile = rt_mobile.trim();
			if(rt_mobile.equals("mobile")){
				view = "board.do?rt=mobile&method=list";
			}
		}
		res.sendRedirect(view);
	}
	...
	private void delete(HttpServletRequest req, HttpServletResponse res) 
		...
		manager.deleteB(dto);
		String view ="board.do?method=list&tableIdx="+noStr;
		String rt_mobile = req.getParameter("rt");
		if(rt_mobile != null){
			rt_mobile = rt_mobile.trim();
			if(rt_mobile.equals("mobile")){
				view = "board.do?rt=mobile&method=list&tableIdx="+noStr;
			}
		}
		res.sendRedirect(view);
	}
	...
	private void content(HttpServletRequest req, HttpServletResponse res) 
		...
		if(rt_mobile != null){
			rt_mobile = rt_mobile.trim();
			if(rt_mobile.equals("mobile")){
				view = "mobile/project/content.jsp";
			}
		}
		RequestDispatcher rd = req.getRequestDispatcher(view);
		rd.forward(req, res);
	...
	private void reply(HttpServletRequest req, HttpServletResponse res) 
		...
		req.setAttribute("newDto", newDto); ////check!!!!!!!!!
		String view = "board.do?method=content&num="+bnum;
		String rt_mobile = req.getParameter("rt");
		if(rt_mobile != null){
			rt_mobile = rt_mobile.trim();
			if(rt_mobile.equals("mobile")){
				view = "board.do?rt=mobile&method=content&num="+bnum;
			}
		}
		res.sendRedirect(view);
		/*
