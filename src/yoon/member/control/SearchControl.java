...
public class SearchControl extends HttpServlet{
	...
	private void searchPwdForm(HttpServletRequest req, HttpServletResponse res)
		...
		if(rt_mobile != null){
			...
			if(rt_mobile.equals("mobile")){
				view = "mobile/search/pwdSearch.jsp";
			}
		}
	...
	private void pwdSearch(HttpServletRequest req, HttpServletResponse res)
		...
		try{
    		...
    		if(rt_mobile != null){
    			rt_mobile = rt_mobile.trim();
    			if(rt_mobile.equals("mobile")){
    				view = "mobile/search/pwdSearchOk.jsp";
    			}
    		}
    		RequestDispatcher rd = req.getRequestDispatcher(view);
    		rd.forward(req, res);
	...
	private void searchIdForm(HttpServletRequest req, HttpServletResponse res)
		...
		if(rt_mobile != null){
			rt_mobile = rt_mobile.trim();
			if(rt_mobile.equals("mobile")){
				view = "mobile/search/idSearch.jsp";
			}
		}
		RequestDispatcher rd = req.getRequestDispatcher(view);
		rd.forward(req, res);
	...
	private void idSearch(HttpServletRequest req, HttpServletResponse res)
		...
		if(rt_mobile != null){
			rt_mobile = rt_mobile.trim();
			if(rt_mobile.equals("mobile")){
				view = "mobile/search/idSearchOk.jsp";
			}
		}
		RequestDispatcher rd = req.getRequestDispatcher(view);
		rd.forward(req, res);
