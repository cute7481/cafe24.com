...
%>
	...
	<tr class="board-normal">
		<td width="5%">&nbsp;</td>
		<td align="left" height="35">&nbsp;<b id="qt">No. </b>
		<font id="qdetail"><%=dto.getNum()%></font></td>
	</tr>
	</table>
	<br>
	<div align="center">
	<table width="700px" height="500px" background="<%=dto.getPic()%>" style="background-size:100%;">
	<tr align="center">
		<td align="center"><font id="picSubj" name="<%=dto.getSubject()%>" 
		style="text-shadow: -2px 0 white, 0 2px white, 2px 0 white, 0 -2px white;
		font-family:Dokdo;font-size:28px;color:black;"><%=dto.getSubject()%></font></td>			
	</tr>
	</table>
	</div>
	<br>
...
%>			
				(<font style="color :#F6CED8;">0</font>)
<%				
			}
%>		
		</td>
